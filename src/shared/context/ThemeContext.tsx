...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const vars: Record<string, string> = {
      ...
      "--dark-primary": colors.secondary || "#1d417f",
      "--dark-secondary": colors.secondary || "#152e60",
      ...
      "--nav-bg": components.navBg || colors.secondary || "#152e60",
      ...
      "--footer-bg": components.footerBg || colors.secondary || "#0d2047",
