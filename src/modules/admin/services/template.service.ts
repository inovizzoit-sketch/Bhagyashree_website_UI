...
export async function previewTemplate(data: TemplatePreviewRequest): Promise<TemplatePreviewResponse> {
  ...
  if (!res.ok) {
    ...
    const payload = data.payload || {
      ...
      phone: "+91 9876543210",
      project_name: "Bhagyashree Imperial Heights",
      project_location: "Banjara Hills, Hyderabad",
      sales_person: "Ananya Roy",
      company_name: "BHAGYASHREE ENTERPRISES",
      ...
      logs: [
        {
          ...
          payload: `{"project_name":"Bhagyashree Imperial Heights","name":"Rahul Sharma"}`,
          status: "DELIVERED",
...
function getFallbackTemplates(type?: string): Template[] {
  const templates: Template[] = [
    ...
    },
    {
      ...
      content: `Thank you {{name}} for inquiring about {{project_name}}. Download pricing & floor plans here: https://bhagyashree.com/p/{{project_name}}. Call {{sales_person}} at {{phone}}`,
